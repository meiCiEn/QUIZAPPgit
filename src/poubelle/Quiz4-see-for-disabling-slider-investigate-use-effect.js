...
function Quiz() {
    ...
    const [sliderEnabledDisabled, setSliderEnabledDisabled] = useState(false);
    ...
    if (finish) {
        ...
        setSliderEnabledDisabled(true);
        return (
            <div className="container ">
                <div className="wrapper text-center">
                    <h3 className="text-center">
                    <br></br>
                        <b>{`Your score is - ${score}`}</b><br></br>
                        {`Game over! Thank you for playing :-)`}<br></br>
                    </h3><br></br>
                    <button
                        ...
                        onClick={() => {
                            ...
                            setPredictedCorrectAnswer(""); startOver();
                            setSliderEnabledDisabled(false);
                        }}
                    >
                        Restart the quiz
                    </button>
            ...
            <div className="container">
                ...
                <div className="block p-6 rounded-lg shadow-lg bg-white max-w-xll">
                    <h2 className="text-2xl text-center py-2">
                        {questions[currentQuestion].question} <b>({`${currentQuestion}/${questions.length}`})</b>
                    </h2>
                    ...
                    <div class="grid grid-cols-2 gap-4 py-2">
                        ...
                        {currentQuestion === questions.length - 1 && (
                            <div className="wrapper">
                                <button
                                    ...
                                    onClick={() => {finishHandler(); setSliderEnabledDisabled(false)}}
                                >
                                    Finish Quiz
                                </button>
                            </div >
                        ...
                        {predictedAnswerCheck && (
                            <div className="wrapper text-right">
                                <button
                                    className="px-6 py-2.5 bg-purple-600 text-white font-medium text-2xl leading-tight uppercase rounded shadow-md hover:bg-purple-700 hover:shadow-lg focus:bg-purple-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out"
                                    onClick={() => { setSliderEnabledDisabled(true); showAnswerPrediction(); setNextQuestion(true); }}
                                >
