...
export const questions = [
    ...
    id: "0",
        ...
        veryLow: {assessment: "Vous en êtes loin. En fait, 42 % des sièges du parlement national étaient occupés par des femmes en 2022 en Belgique. ", text: "Le taux actuel est plus élevé que celui de la plupart des autres pays européens. Seuls cinq pays du monde comptent 50 pour cent ou plus de femmes au parlement dans les chambres uniques ou basses : Le Rwanda (61 %), Cuba (53 %), le Nicaragua (51 %), le Mexique (50 %) et les Émirats arabes unis (50 %).", min: 1, max: 19},
