...
import Image from './man-woman-blob-2.svg';
        ...
        <section className="mb-32  pt-14" style={ { display: `${ showStart ? 'block' : 'none' }` } }>
            ...
            <div className="grid lg:grid-cols-2 gap-6 xl:gap-12 ">
                ...
                <div className="lg:order-1 mb-6 lg:mb-0">
                    <h1 className="text-4xl leading-snug pb-2 text-center lg:text-left">L'égalité hommes-femmes: existe-t-elle vraiment ?</h1>
                    <div className="py-4">
